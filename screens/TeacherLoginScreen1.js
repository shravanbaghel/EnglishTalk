...
const TeacherLoginScreen1 = () => {
            ...
            try {
              ...
              if (!querySnapshot.empty) {
                ...
                if (userData.userType === 'teacher') {
                  ...
                  const store = AsyncStorage.setItem('userType', 'teacher', (error) => {
                    if (error) {
                      console.error('Error setting userType in AsyncStorage:', error);
                    } else {
                      navigation.navigate("LoginSplashScreen", { userType: "teacher" });
                    }
                  ...
                  Alert.alert("Access Denied","This section is reserved for teachers. Please log in using the student login option.");
                  await auth().signOut();
                }
              } else {
  ...
  <SafeAreaView style={{flex:1,backgroundColor:'white'}}>
    ...
    <View style={{paddingHorizontal:30,justifyContent:'center'}}>
      ...
      <Image source={require('../images/teacherLogin1.jpg') } style={styles.image}/>
    ...
    fontSize:16,color:'white'}} >Login</Text>
    </TouchableOpacity>
...
export default TeacherLoginScreen1
